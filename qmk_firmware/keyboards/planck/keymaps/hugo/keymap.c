...
[_LOWER] = {
  ...
  {KC_MUTE, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
...
[_ARROW] = {
  ...
  {KC_LCTL,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_LEFT, KC_DOWN, KC_RIGHT, _______},
  {KC_LSFT,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______, _______, _______,  _______},
  {_______,  _______,  _______,  KC_LGUI,  _______,  _______,  _______,  _______,  KC_LALT, _______, _______,  _______}
},
